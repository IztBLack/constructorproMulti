...
/**
 * Íconos de marca (Android / Apple) para las secciones de descarga.
 *
 * Van RELLENOS (fill), no de trazo como el resto del design system, porque son
 * logos de marca reconocibles y así se leen a primera vista. Paths de Simple
 * Icons. Se comparten entre la landing (`/`) y el modal del portal para no
 * duplicar los mismos SVG en dos lugares.
 */
